...
public class GeomagneticRotationSensorSource extends AbstractSensorSource {
    ...
    public void init(SourceEventListener sourceEventListener, OptionHolder optionHolder, String[] strings, ConfigReader configReader, SiddhiAppContext siddhiAppContext) {
        ...
        if(sensor==null)
            Log.e("Siddhi Source Error","Geomagnetic Rotatioin Sensor is not supported in the device. Stream "+sourceEventListener.getStreamDefinition().getId());
    }
