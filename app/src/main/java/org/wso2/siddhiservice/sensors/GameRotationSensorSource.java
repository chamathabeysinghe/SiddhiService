...
@Extension(
        ...
        namespace = "source",
        description = "Game Rotation Source gets events from game Rotation sensor of android device. The events " +
        ...
        examples = {
                @Example(
                        ...
                        description = "This will consume events from Game Rotation sensor transport " +
...
public class GameRotationSensorSource extends AbstractSensorSource {
    ...
    public void init(SourceEventListener sourceEventListener, OptionHolder optionHolder, String[] strings, ConfigReader configReader, SiddhiAppContext siddhiAppContext) {
        ...
        if (sensor == null) {
            ...
            throw new SiddhiAppCreationException("Game Rotation Sensor is not supported in the device. Stream " + sourceEventListener.getStreamDefinition().getId());
        }
    }
